...
3. **AI-assisted enrichment** — the bundled [`skills/openapi-doc`](skills/openapi-doc/SKILL.md) skill reads real handler code to fill in request/response schemas gin-recon itself doesn't infer, skipping any field already populated by sources 1–2 above.
